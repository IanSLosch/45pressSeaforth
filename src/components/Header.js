...
import toggleMenuIcon from '../assets/images/menu-icon.png'

const Svg = () => {
  return (
    <svg className='social-icons-svg' xmlns="http://www.w3.org/2000/svg" width="147.264" height="18.771" viewBox="0 0 147.264 18.771" >
      <g id="social_icons_no_circle" data-name="social icons no circle" transform="translate(0 0)">
        <a href="https://twitter.com/weareseaforth?lang=en">
        ...
        <a href="https://www.facebook.com/weareseaforth/">
        ...
        <g id="Group_20" data-name="Group 20" transform="translate(59.227 0)">
          <a href="https://www.instagram.com/weareseaforth/?hl=en">
        ...
        <a href="https://www.tiktok.com/@weareseaforth?lang=en">
        ...
        <div className='navigation-wrapper'>
          ...
          <div className='email'>
            ...
            <div className='email-form'>
              <input className='font-light' type='email' placeholder='email address' />
